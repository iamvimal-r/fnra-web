...
import { slidesApi, newsApi, galleryApi, committeeApi, adminContactsApi } from '../../api'

export default function Dashboard({ token }) {
  const [counts, setCounts] = useState({ slides: 0, news: 0, gallery: 0, committee: 0, contacts: 0 })
  ...
  useEffect(() => {
    Promise.all([
      ...
      setCounts({ slides: s.length, news: n.length, gallery: g.length, committee: c.length, contacts: ct.length })
      ...
      <div className="admin-content">
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            ...
            <Link to="/admin/gallery" className="btn btn-outline">🎨 Upload Gallery</Link>
